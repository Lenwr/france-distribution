...
import {collection, updateDoc, doc, getFirestore, deleteDoc, addDoc , getDoc} from 'firebase/firestore'
...
const stocks = useCollection(collection(db, 'stock'))
